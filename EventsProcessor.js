...
import EventsProcessorResult from "./EventsProcessorResult.js";
import ResourceEvent from "./ResourceEvent.js";
import ResourceList from "./ResourceList.js";
import Unit from "./Unit.js";

export default function EventsProcessor() {}

EventsProcessor.prototype.validateActions = function (actions, resourceList) {
    ...
    switch (action.type) {
      ...
      case "train":
        ...
        if (
          ...
          action.valid = false;
          action.error = "building no longer exists";
        }
...
EventsProcessor.prototype.processAction = function (action) {
  ...
  switch (action.type) {
    ...
    case "assignToGold":
      var immediateLoss = new ResourceEvent(action.start, action._id);
      immediateLoss.loseResources({ units: [action.meta.worker] });
