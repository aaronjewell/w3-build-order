...
describe("BuildOrder", () => {
  ...
  it("should have upgrades", () => {
    ...
    expect(buildOrder.upgrades.length === 1).toEqual(true)
    expect(buildOrder.upgrades[0].id).toEqual(pillageData.id)
  })
  ...
  it("should have availableUpgrades", () => {
    const buildOrder = new BuildOrder(Orc)

    expect(buildOrder.availableUpgrades.length > 0).toEqual(true)
  })
