    ...
    for (const action of actions) {
      ...
      switch (action.type) {
        case "build":
          ...
          if (!resourceList.value.units.find((u) => u._id === action.meta.worker._id)) {
              console.log(action.meta.worker, resourceList.value.units);
              action.valid = false;
        ...
        case "train":
          ...
          console.log(action.meta.building._id, resourceList.value.buildings);
          if (
